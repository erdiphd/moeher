...
for reward_type in ['sparse', 'dense']:
    ...
    register(
        id='FetchSlideObs{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchSlideEnvObs',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='FetchPickAndPlaceObs{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPickAndPlaceEnvObs',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    ...
    register(
        id='FetchReachObs{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchReachEnvObs',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    register(
    ...
    register(
        id='FetchPushObs{}-v1'.format(suffix),
        entry_point='gym.envs.robotics:FetchPushEnvObs',
        kwargs=kwargs,
        max_episode_steps=50,
    )
    # Hand
